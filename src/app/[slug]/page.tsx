      ...
      <Grid md={10} mx="auto" xs={12} container>
        <Grid my={{ xs: 8, md: 15 }} xs={12} item>
          <>
            ...
            >
              <Button
                href={`https://www.facebook.com/sharer/sharer.php?u=${baseUrl}/${params.slug}`}
              ...
              <Button
                href={`https://twitter.com/share?url=${baseUrl}/${params.slug}`}
              ...
              <Button
                href={`https://www.linkedin.com/shareArticle?mini=true&url=${baseUrl}/${params.slug}`}
